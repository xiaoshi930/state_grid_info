    ...
    def _get_billing_schema(self, current_standard, is_before_segment=False):
        ...
        # 月阶梯峰平谷_变动价格
            ...
            schema = {
                ...
                vol.Required(f"{CONF_LADDER_PRICE_2}_{CONF_PRICE_PEAK}", default=0.5224): cv.positive_float,
                vol.Required(f"{CONF_LADDER_PRICE_2}_{CONF_PRICE_FLAT}", default=0.5224): cv.positive_float,
                ...
                vol.Required(f"{CONF_LADDER_PRICE_1}_{CONF_PRICE_FLAT}", default=0.6224): cv.positive_float,
